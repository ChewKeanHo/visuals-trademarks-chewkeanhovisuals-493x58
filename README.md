...
6  |       |   ...   |        (Optional) Content Begins Here Centered Vertically
.  |       |   ...   |        (Optional) Content Begins Here Centered Vertically
8  |       |   ...   |        (Optional) Content Begins Here Centered Vertically
...
UUID: 51EF41D1-B9C8-4F34-A9C8-D40187BFCEFF
...
Procure: https://github.com/chewkeanho/visuals-trademarks-chewkeanhovisuals-493x58
```
